...
HTML;
    ...
    protected function getFooter() {
            ...
            <div class="wrap">
                ...
                <div class="sub-menu-footer">
                    <ul>
                        ...
                        <a href="">
                            <li>Дорожные велосипеды</li>
                        </a>
                        <a href="">
                            <li>Шоссейные велосипеды</li>
                        </a>
                        <a href="">
                            <li>Подростковые велосипеды</li>
                        </a>
                        <a href="">
        ...
        <div class="copyright">
            <div class="wrap">
                <p>© 2002-2024, Интернет-магазин ВелоТрейд в Санкт-Петербурге - 22 года нам доверяют покупатели </p>
            </div>
        </div>
    </footer>
HTML;
